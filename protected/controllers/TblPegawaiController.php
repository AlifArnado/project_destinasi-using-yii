...
class TblPegawaiController extends Controller
{
	...
	public function actionTampilkan() {
		$model = Yii::app()->db->createCommand()
			  ->select('tbl_pegawai.nip, tbl_pegawai.nama, tbl_pegawai.alamat, tbl_pegawai.tanggal_lahir, tbl_pegawai.agama')
			  ->from('tbl_pegawai')
			  // ->where('kota.propinsi_id = provinsi.id')
			  ->query();
		$this->render('tampilkan', array('row'=>$model));
	}
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['TblPegawai']))
		{
			...
			$d_nip 			 = $_POST['TblPegawai']['nip'];
			$d_nama 		 = $_POST['TblPegawai']['nama'];
			$d_alamat 		 = $_POST['TblPegawai']['alamat'];
			$d_tanggal_lahir = $_POST['TblPegawai']['tanggal_lahir'];
			$d_agama 		 = $_POST['TblPegawai']['agama'];

			$cmd = Yii::app()->db->createCommand();
			$cmd->insert('tbl_pegawai', array(
					'nip'			=> $d_nip,
					'nama' 			=> $d_nama,
					'alamat' 		=> $d_alamat,
					'tanggal_lahir' => $d_tanggal_lahir,
					'agama' 		=> $d_agama
				));
